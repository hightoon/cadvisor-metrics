...
# Adjust the below value to change the time range, for example use 60 to get the last hour's stats.
NUM_ENTRIES=1440 # Number of entries to aggregate. 1 entry per minutes, 24 hours is 1440 minutes.
